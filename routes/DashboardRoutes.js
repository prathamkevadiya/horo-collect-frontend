...
export const DashboardMenu = [
	...
	},
	{
		...
		children: [
			{
				id: uuid(),
				link: '/pages/products/inventory',
				name: 'Inventory',
			},
			{
				id: uuid(),
				link: '/pages/products/files',
				name: 'Files',
			},
		]
	},
	...
	// 	icon: 'settings',	
	// },
	// { id: uuid(), link: '/pages/profile', title: 'Profile' },
	// { id: uuid(), link: '/pages/settings', title: 'Settings' },
